...
export default function LoginForm() {
  ...
  return (
    <form action={formAction} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-200 px-6 pb-8 pt-10">
        <h1 className={`${lusitana.className} mb-3 text-2xl`}>
          Por favor ingresar credenciales.
        </h1>
        ...
        <h1 className={`${lusitana.className} mb-3 mt-4 text-1xl`}>
          Si aun no tiene usuario: 
        </h1>
        <Link
          href="/register"
        ...
        >
          <span>Registrese</span> <ArrowRightIcon className="ml-auto h-5 w-5 text-gray-50" />
        </Link>
